...
var fs = require("fs");
var filePath = './Day\ 3:\ Gear\ Ratios/input';
function task1() {
    return new Promise(function (resolve) {
        ...
        rl.on('close', function () {
            var _loop_1 = function (i) {
                var rownums = lines[i].split(/[^0-9]/g).filter(function (element) { return element; });
                rownums.forEach(function (num) {
                    var sucess = false;
                    var numpos = lines[i].indexOf(num);
